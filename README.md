                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script Emnvr HUB Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
setclipboard("Emnvr HUB Is The Best")
...
Tabs.Main:AddButton({
        Title = "Emnvr HUB Discord Server",
...
Fluent:Notify({
    Title = "Emnvr HUB",
    Content = "Thanks For Using Emnvr HUB",
    Duration = 8
})
